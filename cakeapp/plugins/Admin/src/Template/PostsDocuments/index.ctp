...
<div class="postsDocuments index large-9 medium-8 columns content">
    <h3><?= __('Posts Documents') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($postsDocuments as $postsDocument): ?>
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $postsDocument->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $postsDocument->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $postsDocument->id], ['confirm' => __('Are you sure you want to delete # {0}?', $postsDocument->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
