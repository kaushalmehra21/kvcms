...
class CategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'image' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'categories_ibfk_1' => ['type' => 'foreign', 'columns' => ['parent_id'], 'references' => ['categories', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'parent_id' => 1,
            'created' => '2017-05-17 16:50:00',
            'modified' => '2017-05-17 16:50:00'
        ],
    ];
}
