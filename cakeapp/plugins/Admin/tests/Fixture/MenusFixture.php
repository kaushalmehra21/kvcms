...
class MenusFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'short_description' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'url' => ['type' => 'string', 'length' => 200, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'serial_number' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'menus_ibfk_1' => ['type' => 'foreign', 'columns' => ['parent_id'], 'references' => ['menus', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'serial_number' => 1,
            'parent_id' => 1,
            'created' => '2017-05-17 16:50:47',
            'modified' => '2017-05-17 16:50:47'
        ],
    ];
}
